...
- Translated file: [click to edit](https://github.com/${repo.owner}/${repo.repo}/edit/${join('auto-translate', translated_file)})
- Open in github.dev editor: [click to open github.dev](https://github.dev/${repo.owner}/${repo.repo}/blob/${join('auto-translate', translated_file)})
`;
